...
USER_TOOLS = [
    ...
    },
    {
        ...
        "description": (
            ...
            "כיתוב שיופיע על הקובץ עצמו חייב לעבור ב-caption (לא כהודעת טקסט נפרדת אחרי הקובץ). "
            "השתמש כשהלקוח מבקש לראות תמונה, דוגמה, קטלוג, מחירון, חוזה, מסמך או כשרלוונטי לשלוח קובץ."
        ),
        "input_schema": {
            "type": "object",
            "properties": {
                ...
                "caption": {
                    "type": "string",
                    "description": (
                        "כיתוב שמופיע יחד עם הקובץ בוואטסאפ. "
                        "אם לא צוין — משתמשים בברירת המחדל של המדיה. "
                        "אל תשלח את אותו טקסט כהודעה נפרדת אחרי הקובץ."
                    ),
                },
            },
            "required": ["media_id"]
...
- כיתוב שמופיע על הקובץ בוואטסאפ — העבר ב-caption של send_media, לא כהודעת טקסט נפרדת אחרי הקובץ
