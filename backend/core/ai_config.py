...
USER_TOOLS = [
    ...
    },
    {
        ...
        "description": (
            "חפש מידע במאגר המסמכים. "
            "כשיש כמה מסמכים וברור באיזה מהם המידע — חובה להעביר document עם שם הקובץ מהרשימה."
        ),
        "input_schema": {
            "type": "object",
            "properties": {
...
- כשנשאל על מסמכים, הסכמים, קבצים או מידע שלא מופיע ישירות למעלה - חובה להשתמש בכלי search_knowledge. אם ברשימת המסמכים יש קובץ שמתאים לנושא השאלה — העבר את שמו ב-document.
