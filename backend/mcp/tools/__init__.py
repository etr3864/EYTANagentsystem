...
Create/update agents, create client accounts (not super-admins), create employees under a client (client_id required), set passwords, assign agents, and edit knowledge/functions/triggers/escalations. Read costs and performance from the super-admin dashboard (get_system_costs, list_agent_costs, get_agent_performance).
